      ...
      <div class="contact-item" style="padding:12px;background:rgba(255,255,255,0.05);border-radius:8px;margin-bottom:8px;" data-phone="${contact.phone}">
        <div style="display:flex;justify-content:space-between;align-items:start;">
          ...
          <div style="display:flex;gap:4px;">
            <button class="contact-edit" data-phone="${contact.phone}" style="padding:6px;background:rgba(255,255,255,0.1);border:none;border-radius:6px;cursor:pointer;">✏️</button>
            <button class="contact-blacklist" data-phone="${contact.phone}" style="padding:6px;background:rgba(255,255,255,0.1);border:none;border-radius:6px;cursor:pointer;">🚫</button>
          </div>
        </div>
      </div>
    `).join('');
