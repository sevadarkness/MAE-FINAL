    ...
    async function callAI(messages, options = {}) {
        ...
        try {
            ...
            if (!state.apiKey || !state.provider || !state.model) {
                throw new Error('Configure o provider e API key nas configurações de IA');
            }
        ...
        try {
            ...
            container.innerHTML = suggestions.map(s => `
                <div class="sr-suggestion-item" data-text="${encodeURIComponent(String(s.text || ''))}">
                    <div class="sr-suggestion-type">${s.type || 'sugestão'}</div>
            ...
            <div class="mod-card">
                ...
                <div style="display:grid;gap:12px">
                    ...
                    <div>
                        ...
                        <input type="password" id="sr-apikey" class="mod-input" placeholder="${provider.id === 'openai' ? 'sk-...' : 'API key'}" value="${state.apiKey ? '••••••••••••••••' : ''}">
                    </div>
                    <div>
