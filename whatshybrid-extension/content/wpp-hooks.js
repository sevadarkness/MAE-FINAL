    ...
    function salvarMensagemRecuperada(msg) {
        ...
        for (const id of possibleIds) {
            ...
            if (cached) {
                ...
                // NOVO: Recuperar dados de mídia
                if (cached.mediaData && cached.mediaData !== '__HAS_MEDIA__') {
                ...
                if (body || mediaData) {
                    console.log('[WHL Recover] ✅ Conteúdo recuperado do cache:', mediaData ? `[MÍDIA:${mediaType}]` : body.substring(0, 50));
                    break;
                }
            }
        }
